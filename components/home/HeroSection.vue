    ...
    >
      ...
      <div class="z-2 relative">
        <div class="container md:grid md:grid-cols-2">
          ...
          <div class=""></div>
          <div
            class="max-w-xl border rounded-2xl text-start bg-background p-6 outline outline-2 outline-orange-800 outline-offset-[6px] mt-10 md:-mt-[75px] ms-auto"
          >
            <h1 class="text-2xl font-bold flex gap-4">
              <MessageCircleMore class="mt-2" />
              Your technology partner for digital solutions.
            </h1>
            <p class="mt-2 mx-auto text-gray-500 pl-9">
              ...
              engage, push and deliver software which allows for businesses to
